    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            children: [
              Text(widget.book.title, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
              ...
              Container(
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              Text(widget.book.rating.toString(), style: const TextStyle(fontSize: 15)),
                            ],
                          ),
                          const SizedBox(width: 55,),
                          ...
                          Column(
                            children: [
                              ...
                              const SizedBox(height: 3,),
                              Text(widget.book.pages.toString(), style: const TextStyle(fontSize: 15)),
                            ],
                          ),
                        ],
                      ),
                    ...
                    const SizedBox(height: 3,),
                    Text(widget.book.author, style: const TextStyle(fontSize: 17),),
                    ...
                    const SizedBox(height: 3,),
                    Text(widget.book.isbn, style: const TextStyle(fontSize: 17),),
                    const SizedBox(height: 15,),
